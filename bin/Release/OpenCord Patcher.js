...
window.XMLHttpRequest.prototype.open = function(method, url, async = true)
{
	...
	{
		url = url.replace("https://discord.com", "http://127.0.0.1:9987");
	}
	
	if (url != "http://127.0.0.1:9987/api/v9/science" && url != "http://127.0.0.1:9987/api/v9/users/@me/affinities/users" && url != "http://127.0.0.1:9987/api/v9/applications/detectable" && url != "http://127.0.0.1:9987/api/v9/users/@me/library" && url != "http://127.0.0.1:9987/api/v9/users/@me/affinities/guilds" && url != "http://127.0.0.1:9987/api/v9/users/@me/survey" && url != "http://127.0.0.1:9987/api/v9/users/@me/billing/user-trial-offer" && url != "http://127.0.0.1:9987/api/v9/users/@me" && url != "http://127.0.0.1:9987/api/v9/auth/location-metadata" && url != "http://127.0.0.1:9987/api/v9/auth/logout" && url != "http://127.0.0.1:9987/api/v9/experiments" && !url.includes("/cdn-cgi/bm/cv/") && !url.includes(".js.map"))
	{
...
window.GLOBAL_ENV.GATEWAY_ENDPOINT = 'ws://127.0.0.1:9988/ws';
